...
const cardContent: ICardContent = {
  ...
  figma: {
    ...
    I have not had the chance to work in teams so far. I used Figma to design the layouts of this website as well as some vector graphics. I think it is so valuable and time-saving to have a clear idea of what to implement and so to first design it. I really loved using Figma. I wonder how it compares to its competitors.
    `,
  },
  jquery: {
    title: 'jQuery',
    content: `jQuery is a very powerful and widely-used javascript library.`,
    expandedContent: `jQuery has been around for quite some time and has now achieved the highest rank in terms of usage in modern web. Its synthax is very elegant and concise. It makes it easy to handle the DOM (for animations for instance or for content update), handle events, make AJAX calls and much more. Another advantage is its size, compared to other javascript libraries out there. I like jQuery and I have used it in one of my projects.
    `,
  },
  cpp: {
    title: 'C++',
    content: `C++ is an OOP language designed for the purpose of perfomance.`,
    expandedContent: `C++ is an object-oriented programming language. I learned C++ during my college years as part of the curicculum. It was the next step after C. I love the idea of object orientated programming. Abstraction, reusability, atomization (as I call it) makes this tool very useful for some problems. My most recent experience with C++ was to optimize a code where objects in 3D space were rendered every frame based on the position of the observer. It was hard because I just had the file with no explanations and had to figure what was actually happening before I could come up with solutions to make the rendering faster.
    `,
  },
  javascript: {
    title: 'Javascript',
    content: `Javascript is a core technology of the web. It goes without saying that it is widely used.`,
